...
import project3 from '@/assets/Vidyaplus.jpg';

const projects = [
  {
    title: 'Kishore Raksha ',
    description: 'A digital student health platform enabling secure health record management and access through unique IDs',
    image: project1,
    tags: ['React', 'TypeScript', 'Tailwind.CSS','Node.js','Express', 'PostgreSQL'],
    liveUrl: 'https://kishore-raksha.vercel.app/',
    githubUrl: 'https://github.com/rajesh31109/Kishore-Raksha.git',
    featured: true,
  },
  {
  ...
  {
    title: 'VidyaPlus',
    description: 'A smart student portal for digital learning, session-based quizzes, and comprehensive student support services.',
    image: project3,
    tags: ['React', 'Next.js', 'Tailwind.CSS', 'Node.js', 'MySQL',],
    liveUrl: '#',
    githubUrl: '#',
    featured: true,
  },
